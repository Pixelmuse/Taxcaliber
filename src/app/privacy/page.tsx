    ...
    <>
      ...
      <section className="section">
        <div className="container legal-content">
          ...
          <h2 className="section__title">Analytics & Tracking</h2>
          <p>
          ...
          <h2 className="section__title">Cookies</h2>
          ...
          <h2 className="section__title">How We Use Information</h2>
          <ul className="list-check">
          ...
          <h2 className="section__title">Data Sharing</h2>
          <p>
          ...
          <h2 className="section__title">Your Rights</h2>
          <p>
